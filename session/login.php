    ...
    <div id="main">
        ...
        <div id="HOME">
            <section class="login">
                ...
                ?>
                            <div class='success'>Welcome, <?php echo $_SESSION['mem_ID'] ?>! You have successfully logged in.</div>
                            <div class='box'>
                                <p>Time is of the essence</p>
                                <p>Work smarter, not harder</p>
                                <p>Prioritize your tasks</p>
                            </div>
                            <div class='success'>with your task manager Team NUMBER ONE</div>
                        ...
                        ?>
                            <br> Invalid ID or password.
                            <div class='error box'> <?php $login_error ?> </div>
